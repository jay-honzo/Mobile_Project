...
//        }
    ...
    @objc fileprivate func tokenRefreshNotification(notification: NSNotification) {
    ...
    func connectToFcm(){
        Messaging.messaging().connect(handler: {
            (error) in
            if error != nil{
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        let container = NSPersistentContainer(name: "PhotoMemo")
